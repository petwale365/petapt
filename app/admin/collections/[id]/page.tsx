      ...
      <div className="mx-auto max-w-screen-2xl space-y-8 p-4 pt-6 md:p-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {format(new Date(collection.created_at!), "yyyy")}
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {collection.seo_keywords?.length || 0}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Badge variant={collection.seo_title ? "default" : "secondary"}>
                {collection.seo_title ? "Optimized" : "Not Set"}
              </Badge>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="rounded-md bg-muted p-3">
                    <p className="text-sm">
                      {collection.seo_title || "No SEO title set"}
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="rounded-md bg-muted p-3">
                    <p className="text-sm">
                      {collection.seo_description || "No SEO description set"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ScrollArea className="h-[180px] rounded-md border">
                  <div className="flex flex-wrap gap-2 p-4">
                    {collection.seo_keywords?.map((keyword) => (
                      <Badge
                        key={keyword}
                        variant="secondary"
